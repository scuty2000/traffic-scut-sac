...
public class TrafficLightAnimationComponent extends Component {
	...
	public TrafficLightAnimationComponent() {
		animRed = new AnimationChannel(FXGL.image("tiles_sheet.png"), 2, 250, 250, Duration.seconds(1), 1, 1);
	...
	public void onUpdate(double tpf) {
		if(isRed && toSwitch) {
			...
			System.out.println("toSwitch: "+toSwitch+". AnimationChannel: "+texture.getAnimationChannel()+". "+tpf);
			isRed = false;
